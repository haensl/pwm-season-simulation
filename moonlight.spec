...
void setup() {
  ...
  byte hourOfMoonrise = getMoonriseHour(dayOfYear);
  byte luminosityMax = getMaximumLuminosity(dayOfMonth);
  Serial.print("\n");
  Serial.print("---\n");
  Serial.print("Moonlight intensity for day ");
  Serial.print(dayOfYear);
  Serial.print("\n");
  Serial.print("Maximum luminosity ");
  Serial.print(luminosityMax);
  Serial.print("\n");
  Serial.print("Moonrise ");
  Serial.print(hourOfMoonrise);
  Serial.print("\n");
  Serial.print("Hours of moonlight ");
  Serial.print(hoursOfMoonlight);
  Serial.print("\n");
  ...
  for (byte k = 0; k < 48; k++) {
    hourOfDay = k % 24;
    // byte hoursOfMoonlight, byte hourOfMoonrise, byte maxLuminosity, Time aTime
    for (byte l = 0; l < 60; l++) {
      luminosity = getLuminosity(hoursOfMoonlight, hourOfMoonrise, luminosityMax, { hourOfDay, l, 0 });
      Serial.print("Luminosity at ");
...
byte getLuminosity(byte hoursOfMoonlight, byte hourOfMoonrise, byte maxLuminosity, Time t) {
  ...
  Serial.print(hoursOfMoonlight);
  Serial.print("\n");
  Serial.print("currentMoonhour ");
  Serial.print(currentMoonhour);
  Serial.print("\n");
  Serial.print("hourOfMaximumLuminosity ");
  Serial.print(hourOfMaximumLuminosity);
  Serial.print("\n");
  Serial.print("time ");
...
/**
  if (currentMoonhour <= hourOfMaximumLuminosity) {
    return round(currentMoonhour * luminosityStep);
  }*/
